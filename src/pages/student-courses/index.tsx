    ...
    <AppLayout>
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        {hasAccess('student_course', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
          <Link href={`/student-courses/create`}>
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('student_course', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && <Th>Edit</Th>}
                  {hasAccess('student_course', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>View</Th>}
